...
// import '../../modules/User Screens/first_screen.dart';
// import '../../modules/Worker Dashboard/bottom_nav.dart';

// class TrySkills extends StatefulWidget {
//   const TrySkills({ Key? key }) : super(key: key);

//   @override
//   State<TrySkills> createState() => _TrySkillsState();
// }

// class _TrySkillsState extends State<TrySkills> {
...
//         stream: FirebaseFirestore.instance.collection("tryskill").snapshots(),
...
//                  DocumentSnapshot tryskills = snapshot.data!.docs[index];
...
//                                print("Skill name"+ tryskills['Name'],);
                               
//                 String service;
//                 Navigator.of(context).push(MaterialPageRoute(
//                                   builder: (context) => TryScreen(
//                                       SkillName = tryskills['Name'],
//                                       service = tryskills['Services'],
